...
const tournaments = [
    {
        name: 'Inter IIM Hockey | IIM B Vs IIM A ',
    ...
    {
        name: 'Inter IIT Basket ball | Quarter final',
    ...
    {
        name: 'Inter IIT TT | IIM K Vs IIM A',
        org: 'IIT Sports Association',
        date: '27th Oct, 2023',
        views: '285',
        image: t_footb,
...
export default function LatestMatchesSection() {
  return (
    <div className="w-full bg-black py-8">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-white text-5xl font-bold font-montserrat">Latest Matches</h2>
